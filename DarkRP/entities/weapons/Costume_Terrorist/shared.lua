...
if( CLIENT ) then
	...
	SWEP.PrintName = "Terrorist Costume";
	SWEP.Slot = 3;
	SWEP.SlotPos = 1;
	SWEP.DrawAmmo = false;
...
SWEP.Instructions	= "Left Click To Dress As A Terrorist. Right Click To Change Back."
...
function SWEP:PrimaryAttack()
	...
	self.Owner:SetModel("models/player/phoenix.mdl")
end
