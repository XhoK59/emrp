...
function SWEP:PrimaryAttack()
	...
	if trace.Entity:OwnedBy(self.Owner) or (trace.Entity:GetNWBool("CPOwnable") and (Team == TEAM_CHIEF or Team == TEAM_POLICE or Team == TEAM_UNDERCOVERCOP or Team == TEAM_MAYORSPROTECTOR or Team == TEAM_MAYOR)) then
