...
if( CLIENT ) then
	...
	SWEP.PrintName = "Car Dealer Costume";
	SWEP.Slot = 3;
	SWEP.SlotPos = 1;
	SWEP.DrawAmmo = false;
...
SWEP.Author			= "Epinephrine"
SWEP.Instructions	= "Left Click To Dress As A Car Dealer. Right Click To Change Back."
SWEP.Category		= "JRRP Costumes"
SWEP.Contact		= ""
SWEP.Purpose		= ""
...
function SWEP:PrimaryAttack()
	...
	self.Owner:SetModel("models/player/hostage/hostage_02.mdl")
end
