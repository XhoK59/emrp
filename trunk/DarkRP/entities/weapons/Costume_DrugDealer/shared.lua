...
if( CLIENT ) then
	...
	SWEP.PrintName = "Drug Dealer Costume";
	SWEP.Slot = 3;
	SWEP.SlotPos = 1;
	SWEP.DrawAmmo = false;
...
SWEP.Instructions	= "Left Click To Dress As The Drug Dealer. Right Click To Change Back."
...
function SWEP:PrimaryAttack()
	...
	self.Owner:SetModel("models/player/guerilla.mdl")
end
