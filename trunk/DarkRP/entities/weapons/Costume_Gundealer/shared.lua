...
if( CLIENT ) then
	...
	SWEP.PrintName = "Gun Dealer Costume";
	SWEP.Slot = 3;
	SWEP.SlotPos = 1;
	SWEP.DrawAmmo = false;
...
SWEP.Instructions	= "Left Click To Dress As A Gun Dealer. Right Click To Change Back."
...
function SWEP:PrimaryAttack()
	...
	self.Owner:SetModel("models/player/monk.mdl")
end
