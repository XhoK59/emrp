...
if( CLIENT ) then
	...
	SWEP.PrintName = "Lock Smith Costume";
	SWEP.Slot = 3;
	SWEP.SlotPos = 1;
	SWEP.DrawAmmo = false;
...
SWEP.Instructions	= "Left Click To Dress As A Lock Smith. Right Click To Change Back."
...
function SWEP:PrimaryAttack()
	...
	self.Owner:SetModel("models/player/eli.mdl")
end
