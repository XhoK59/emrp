...
if( CLIENT ) then
	...
	SWEP.PrintName = "Mob Boss Costume";
	SWEP.Slot = 3;
	SWEP.SlotPos = 1;
	SWEP.DrawAmmo = false;
...
SWEP.Instructions	= "Left Click To Dress As The Mob Boss. Right Click To Change Back."
...
function SWEP:PrimaryAttack()
	...
	self.Owner:SetModel("models/player/gman_high.mdl")
end
